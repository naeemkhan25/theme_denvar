...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/denver.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/denver)
...
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for denver.

At the moment, denver is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# denver WordPress Theme Framework

Website: [http://denver.com](http://denver.com)

Child Theme Project: [https://github.com/holger1411/denver-child](https://github.com/holger1411/denver-child)

## License
denver WordPress Theme, Copyright 2013-2017 Holger Koenemann
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or denver variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "denver/denver"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the denver folder from GitHub or from denver.com
